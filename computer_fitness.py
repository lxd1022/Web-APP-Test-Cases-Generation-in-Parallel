...
def handle_txt():
    list = []
    result = []
    f = open("D:\\programs\\wamp\\www\\schoolmate2\\muser_result.txt", "r")
...
def handle_target():
    target = []
    f = open("D:\\PyCharm Community Edition 2017.2\\projects\\graphTraversal\\path_code_line_number\\mangeruser.txt", "r")
    lines = f.readlines()  # 读取全部内容
    for line in lines:
        # print line
        line = line.strip()
